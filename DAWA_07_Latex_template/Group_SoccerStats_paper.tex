...
Then, in Section~\ref{sec:concept} we describe our tools to create our Data Warehouse and to generate analysis from it. Section~\ref{sec:impl} we describe the Data Preparation for our Data Warehouse. In Section~\ref{sec:further} we explain the how we input the data and the CDHW and the Data Mart.  In Section~\ref{sec:analy} we analyze the result of our data. Finally, we conclude our work in Section~\ref{sec:concl} with our achievements and a feedback of this project.
...
\begin{figure}[htb]
	...
	\caption{Performance from 5 Teams in the last two seasons }
	\label{tab:probov}
\end{figure}
\begin{figure}[htb]
	\centering
...
\begin{figure}[htb]
	...
	\caption{Comparison between Dortmund and Bayern Munich over the last 3 seasons}
	\label{fig:probov}
\end{figure}
